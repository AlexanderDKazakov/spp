...
CONFIG = {
    ...
    "motion_type":     MOTIONS.TRANSLATION,
    "motion_type_params": {
        MOTIONS.ROTATION : {
            "variable":               "theta0",
            "initial_variable_value": 0*unit.radian,
            "atom_indices":           [(29, 30, 9, 8), ],                                # idx tortion 2 blue corner
        ...
        MOTIONS.TRANSLATION : {
            ...
            "atom_indices":           [(4, 25), (2, 23), (6, 27), ],                       # idx  core segment
            "cv_formula":             "0.5 * fc_pull * (cv-r0)^2",                         # formula
            "fc_pull":                1000.0 * unit.kilojoule_per_mole/unit.nanometers**2, # kJ/nm**2 # force constant
            "velocity_pulling":       0.0005 * unit.nanometers / unit.picosecond,          # nm/ps
            "windows":                np.linspace(0.2, 0.6, 26),                           # desired values
        }
    },

    # PER WINDOW SETUP
    "total_steps":                 50_000_000, # delta t
    "cv_record_steps":             1000,       # delta t| CV
    "report_steps":                1_000,     # delta t| State|PDB
    "windows_short_equilib_steps": 500_000,    # delta t | 500_000 too short
